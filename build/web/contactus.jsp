    ...
    <div class="container">
        ...
        <div class="row contactus-details-row">
            ...
            <div class="col-sm-4 pe-5 ps-5" style="display:flex; align-items: center; text-align: center;" data-aos="fade-up">
                <p style="font-size: 18px; font-weight: bold;"><i class="fa-solid fa-phone me-3" style=" color: #ffc107;"></i> +91 9935790781<br/>+91 7309868656</p>
            </div>
            
            <div class="col-sm-4 pe-5 ps-5" style="display:flex; align-items: center; text-align: justify;" data-aos="fade-up">
                <p style="font-size: 18px; font-weight: bold;"><i class="fa-solid fa-envelope me-3" style=" color: #ffc107;"></i>yogi@gpmahoba.in, yogendra@gpmahoba.in</p>
            </div>
        </div>
