...
<div class="row Header sticky-top">
              <div class="col-sm-12">
                  <div class="row header-details-section pt-2">
                      ...
                      <div class="col-sm-3" style="border-right: 1px solid white;"><i class="fa-solid fa-phone me-2"></i> +91 9935790781, 7309858656</div>
                      
                      <div class="col-sm-3" style="border-right: 1px solid white;"><i class="fa-solid fa-envelope me-2"></i> yogichaurasiya@gpmahoba.in</div>
